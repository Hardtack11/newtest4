...
<div class="post-pushed-item d-flex flex-row my-4">
    <div class="media media-3x2 rounded col-4 col-md-3">
        <a href="'.get_permalink($post).'" class="media-content" style="background-image:url('.timthumb( pandapro_post_thumbnail_src(), array( 'w' => '160', 'h' => '120' ) ).')"></a>
    </div>
    <div class="post-pushed-body pl-3">
        <div class="post-pushed-content ">
            <a href="'.get_permalink($post).'" class="post-pushed-title text-lg h-2x">'.get_the_title().'</a>
            <div class="post-pushed-desc d-none d-md-block text-sm text-secondary mt-2">
                <div class="h-2x ">'.nc_print_excerpt(60,null,false).'</div>
            </div>
        </div>
