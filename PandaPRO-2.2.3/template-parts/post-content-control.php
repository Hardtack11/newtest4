...
<?php
        ...
        the_content();
        ?>
<div class="post-restrict-area border border-light border-2 rounded text-center site-main mb-3">
    <div class="restrict-text text-sm text-secondary"><?php _e('Restricted content', 'pandapro') ?></div>
    <div class="restrict-action mt-3"><a
            href="<?php echo !defined('NC_APOLLO_DIR') ? wp_login_url(get_the_permalink()) : $apollo_auth_url . '/user/login' ?>"
            class="btn btn-primary"><?php _e('Login to read more...', 'pandapro') ?></a></div>
</div>
<?php endif; ?>
<?php endif; ?>
...
<div class="post-restrict-area border border-light border-2 rounded text-center site-main mb-3">
    ...
    <div class="restrict-action mt-3"><a href="#comments"
            class="btn btn-primary"><?php _e('Comment to read more...', 'pandapro') ?></a></div>
</div>
<?php endif; ?>
<?php endif; ?>